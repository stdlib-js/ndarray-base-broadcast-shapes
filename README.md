...
```javascript
broadcastShapes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-broadcast-shapes@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-broadcast-shapes@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-left-pad@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-broadcast-shapes@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
